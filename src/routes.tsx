...
import SrProm from "./pages/projectPages/srProm/srProm";
import VeteransCemetary from "./pages/projectPages/veteransCemetery/veteransCemetery";
...
import LogoDesigns from "./pages/projectPages/logos/logoDesigns";
import SocialMediaAdvertisements from "./pages/projectPages/socialMediaAdds/socialMediaAdvertisements";
import Advertisements from "./pages/projectPages/advertisements/advertisements";
